function [] = get_uni_transmodel_var(data_name,data_path)
...
inter_regess_intra = inter_regess_intra.final_matrix;
...
transmodel = convet_matrix_to_vector(inter_regess_intra_7net_order(lines(3):lines(8)-1,lines(3):lines(8)-1));

uni_trans_area = inter_regess_intra_7net_order(lines(3):lines(8)-1,lines(1):lines(3)-1);
uni_trans_area = reshape(uni_trans_area,1,262*138);

save([root_DIR filesep 'unimodel.mat'],'unimodel');
save([root_DIR filesep 'transmodel.mat'],'transmodel');
save([root_DIR filesep 'uni_trans_area.mat'],'uni_trans_area');
end
