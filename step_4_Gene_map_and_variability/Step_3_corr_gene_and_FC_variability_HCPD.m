...
%%
%gene_map_std = get_gene_map_within_HCPD(gene_scheafer_label) %get the inter-reg-intra variability from HCPD data
load('/GPFS/cuizaixu_lab_permanent/wuguowei/python_code/project/SingleParcellation_Kong_HCPD/gene_segement/inter_reg_intra_var.mat')
...
save([gene_dir '/HCPD_no_lim_net_label.mat'],'no_lim_net_label');
plot_variability_matrix_gene(gene_hava_corr_no_lim,-0.5,0.5)
plot_variability_matrix_gene_FC(variability_matrix_no_lim,0.22,0.26)
%%
...
HCPD.gene_corr_set = gene_corr_set';
HCPD.variability_set = variability_set';
HCPD_gene_FC_var = struct2table(HCPD);
writetable(HCPD_gene_FC_var,[gene_dir '/HCPD_gene_FC.csv'],'FileType','text');