...
topo_variability = load('/GPFS/cuizaixu_lab_permanent/wuguowei/python_code/project/HCPA_single_parcel/Variabiltiy.mat');
...
cifti_write(dlabel_tem,'/GPFS/cuizaixu_lab_permanent/wuguowei/python_code/project/HCPA_single_parcel/Variabiltiy_topo_final.dscalar.nii');