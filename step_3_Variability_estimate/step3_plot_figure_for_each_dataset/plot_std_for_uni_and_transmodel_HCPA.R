library(bruceR)
unimodel <- as.matrix(rio::import("/GPFS/cuizaixu_lab_permanent/wuguowei/python_code/project/HCPA_single_parcel/unimodel.mat"))
trans_model <- as.matrix(rio::import("/GPFS/cuizaixu_lab_permanent/wuguowei/python_code/project/HCPA_single_parcel/transmodel.mat"))
